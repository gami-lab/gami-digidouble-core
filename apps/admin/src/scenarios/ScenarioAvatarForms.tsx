...
const COMPUTED_TRAIT_SECTIONS: Array<{ label: string; key: keyof AvatarComputedTraits }> = [
  ...
  { label: 'Behavioural rules', key: 'behaviouralRules' },
]
...
function AvatarComputedTraitsView({ computedTraits }: AvatarComputedTraitsViewProps): JSX.Element {
  return (
    <div className="admin-form-group">
      ...
      {COMPUTED_TRAIT_SECTIONS.map(({ label, key }) => {
