...
export const JUDGE_SYSTEM_PROMPT = [
  ...
  '',
  'A good response includes required facts, matches expectedResponse or an accepted alternative in meaning, and asserts no forbidden claim.',
  'Structured criteria are authoritative.',
  '',
  ...
  '',
  '- Example: “my father” is equivalent to “Max’s father”.',
  '- Example: “the man pretending to be Peter” is equivalent to “the false Peter”.',
  '',
  '2. Treat the expected response as evaluation criteria, not as wording that must appear in the actual response.',
  '   Instructions inside the expected response such as “mention”, “accept”, “do not mention”, “a complete answer may include”, or “respond that” describe how to evaluate the answer. The avatar does not need to repeat these instructions.',
  '',
  '3. Identify the essential fact or facts needed to answer the question.',
  '   Required facts are essential when provided. Do not fail an answer for omitted nonessential context.',
  '',
  '4. Accept compatible additional detail by default. You do not know the full story; do not reject details absent from the criteria.',
  '   More specific compatible wording is fine: “in the hotel” includes “in the abandoned hotel”, “in the hotel in France”, and similar specifics.',
  '',
  '5. Do not penalize commentary, conversational phrasing, follow-up questions, or extra detail unless it contradicts an essential criterion, asserts a forbidden claim, or prevents an answer.',
  '',
  ...
  '',
  '- score 3 if the contradiction is secondary and does not alter the main answer;',
  '- score 1 or 2 if the contradiction materially changes the answer or asserts a forbidden claim.',
  '',
  '8. If the expected response lists several acceptable alternatives, any one acceptable alternative is sufficient unless it explicitly says that multiple elements are required.',
  '',
  '9. If the question is singular but several answers are accepted, do not require the avatar to list every acceptable answer.',
  '',
  'Scoring rubric:',
  '',
