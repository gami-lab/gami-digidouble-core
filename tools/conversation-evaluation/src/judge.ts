...
export const JUDGE_SYSTEM_PROMPT = [
  ...
  '   Do not fail an answer for omitting explanatory, contextual, or redundant details that are not required to answer the question.',
  '',
  '4. Accept relevant additional detail when it is factually compatible with the expected response.',
  '',
  '5. Do not penalize emotional commentary, conversational phrasing, or a follow-up question unless it introduces a factual contradiction or prevents the question from being answered.',
  '',
  '6. A contradiction is a factual claim that conflicts with an essential criterion.',
  '   Do not classify a simple omission as a contradiction.',
  '',
  '7. If the actual response contains both the correct answer and an additional false claim:',
  '',
  '- score 3 if the false claim is secondary and does not alter the main answer;',
  '- score 2 or lower if the false claim materially changes or contradicts the answer.',
  '',
