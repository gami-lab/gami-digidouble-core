...
| PostgreSQL filters scenario, ready status, type, visibility, active profile, and corpus generation before limiting | Same PostgreSQL integration test; matching in-memory contract tests provide deterministic fallback coverage                                                                                                     | Covered when PostgreSQL is available         |
