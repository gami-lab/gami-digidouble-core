...
| Retrieval evaluation       | Offline IR metrics (recall@k, MRR/nDCG) against a labelled query set                                                                                                                        | A small opt-in recall@k/MRR harness now covers six labelled murder-party queries; the broader conversation-evaluation harness still judges whole conversations | The baseline closes the measurement gap for the current 16-dimension profile, but it is intentionally not a general framework, dashboard, or CI gate.                                                                                                                                                                                                                                |
