...
**Current state**
The contract-cleanup and tool-foundation slices are shipped; no standalone, repeatable evaluation
runner yet exists for comparing scripted Avatar conversations across configured runtime models.
