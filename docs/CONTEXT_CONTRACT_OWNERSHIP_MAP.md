...
- The admin retrieval tester derives its temporary scope form from the shared retrieval request
  type, and the Avatar prompt test derives its retrieval item category from shared `KnowledgeType`.
